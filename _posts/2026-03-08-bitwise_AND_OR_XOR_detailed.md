---
layout: post
title: "按位与、按位或、按位异或（详细版）"
---

注：本文原始版本写于2025年12月，可以从这里找到：[https://github.com/qp91mn64/sketches_black_white/blob/main/docs/bitwise_AND_OR_XOR_detailed.md](https://github.com/qp91mn64/sketches_black_white/blob/main/docs/bitwise_AND_OR_XOR_detailed.md)。为便于查找，就发到个人博客。后续可能更新。
以下是正文：
